...
public class ArquillianService implements Service {
    ...
    private static final String TEST_CLASS_PROPERTY = "org.jboss.as.arquillian.testClass";
    private static final ServiceName SERVICE_NAME = ServiceName.JBOSS.append("arquillian", "testrunner");
        ...
        public void handleEvent(final ServiceController<?> controller, final LifecycleEvent event) {
            ...
            if (simpleName.equals(Phase.DEPENDENCIES.toString())) {
                ...
                if (testClasses != null) {
                    ...
                    ServiceBuilder<?> builder = serviceTarget.addService(arqConfigSN);
